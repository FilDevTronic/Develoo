...
class CommissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create commission' do
    assert_difference('Commission.count') do
      post commissions_url, params: { commission: { description: @commission.description, price: @commission.price, title: @commission.title, user_id: @commission.user_id } }
    end
  ...
  test 'should update commission' do
    patch commission_url(@commission), params: { commission: { description: @commission.description, price: @commission.price, title: @commission.title, user_id: @commission.user_id } }
